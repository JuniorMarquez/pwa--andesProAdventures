...
import { ToptreksComponent } from './components/toptreks/toptreks.component';
import { TrekgalleryComponent } from './components/trekgallery/trekgallery.component';
import { BottomtreksComponent } from './components/bottomtreks/bottomtreks.component';
import { TreksliderComponent } from './components/trekslider/trekslider.component';
...
@NgModule({
  declarations: [
    ...
    ContactComponent,
    ToptreksComponent,
    TrekgalleryComponent,
    BottomtreksComponent,
    TreksliderComponent,
    TreksportComponent
  ],
  imports: [
